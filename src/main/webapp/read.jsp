    ...
    <div class="header-w36">
		        ...
		        <div class="header-w36-person">
		               ...
		               <!--  <input type="text" id="reciever" name="reciever" style="width: 670px;height: 19px;"/> -->
		               	<%
		               		if(session.getAttribute("emailt")!=null){
		               			Email email=(Email)session.getAttribute("emailt");
		               			out.print(email.getReciever());
		               		}
		               	%>
		            </h1>
		            <h2>
		            ...
		            <h3>
		                <label id="" class="header-w36-buton-input-lable" style="cursor:pointer;" for="xfile">添加附件</label>
		        ...
		        <div class="header-w36-person">
		            <div style="margin-top:20px;background: #dde0e2;height: 295px;">
		                    ...
		                    <span style="width: 200px;height: 500px"><% if(session.getAttribute("emailt")!=null){
		               			Email email=(Email)session.getAttribute("emailt");
		               			out.print(email.getTitle());
		               		}%></span>
		                     ...
		                     <div style="padding-left:55px;padding-top:320px;font-size:10px;float:left;color:#6d4b9f;">
