				...
				if(list[0]=="False"){
					...
					for(var i=0;i<list.length;i++){
						...
						if(list[i].filePath==" "){
							...
							var fu='<td><span><input id="'+list[i].filePath+'" type="button" value="下载" onclick="xiazai(this);"/></span></td>';
						}
						$("#tbody").append(str+list[i].reciever
								+"</span></td><td><span>"
								+list[i].text+fu+"</span></td><td><span>"+d.getFullYear()+"-"+month+"-"+d.getDate()+" "+d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()+"</span></td></tr>");
					}
				}
			}
		})
    ...
    <div class="header-w35">
           <div class="header-w35-dao">
            ...
            <div class="header-w35-xian">
                ...
                <a href="caogao.jsp" ><h1 onmouseover="onover(this);" onmouseleave="onleave(this);"> 草稿箱(4)</h1></a>
