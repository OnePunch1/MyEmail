    ...
    <div class="header-w36">
				...
				<div class="header-w36-zongji">
		      	...
		      	<div class="header-w36-zongji-1">
		      	 	<span>共0封,其中<a href="#">未读邮件</a>1封</span>
		      	 </div>
		      	
		      	<div class="header-w36-wen" style=" letter-spacing:4px;  width:865px;height:475px;float:left;padding-top:8px;padding-left:35px;background-color:#d3d6d8;">
			      	 <a href="reciever.jsp">收件箱(1)</a>
			      	 <a href="caogao.jsp">草稿箱(1)</a>
			      	 <a href="#">垃圾箱(1)</a>
		      	</div>
